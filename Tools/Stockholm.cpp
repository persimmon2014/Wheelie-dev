...
//         }
    ...
    void draw()
    {
        if (!valid())
        {
            ...
            glLoadIdentity();
            gluPerspective(45.0f, (GLfloat)w()/(GLfloat)h(), 600.0f, 14000.0f);
        ...
        case FL_MOUSEWHEEL:
            {
                ...
                back_image_scale  *= std::pow(2.0f, 0.001f*fy);
...
//    s.convert_cars(hybrid::MACRO);
    ...
    mv.back_image_center = vec2f(-3255.47f, -53.6186f);
    mv.back_image_scale =  1.23601;
